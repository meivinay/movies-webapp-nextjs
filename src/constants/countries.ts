...
const SUPPORTED_REGIONS = ["IN", "US", "JP", "KR"] as const;

export default SUPPORTED_REGIONS;
// const SUPPORTED_COUNTRIES = COUNTRIES.filter((country) => {
//   SUPPORTED_REGIONS.includes(country.iso_3166_1);
// });
